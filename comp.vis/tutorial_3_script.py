...
import cv2
from patches import cv2_imshow
import numpy as np
import math

#################################################################################################################################
#img_queens_tower = cv2.imread('Tutorial3-Data/Tutorial3-Data/Template.png')
#cv2_imshow(img_queens_tower)
#print(img_queens_tower.shape)
################################################################################################################################

#BELOW IS THE CODE. TRY AND MAKE IT WORK

## [global_variables]
use_mask = False
#Note changed this
img = cv2.imread('Tutorial3-Data/Tutorial3-Data/Scene.png')
templ = cv2.imread('Tutorial3-Data/Tutorial3-Data/Template_small.png')
cv2_imshow(img)
cv2_imshow(templ)
mask = None
